...
CREATE TABLE ${schema}NATION${org}  ( N_NATIONKEY  INTEGER NOT NULL WITH STORAGETYPE = COLUMNAR,
...
CREATE TABLE ${schema}REGION${org}  ( R_REGIONKEY  INTEGER NOT NULL WITH STORAGETYPE = COLUMNAR,
...
CREATE TABLE ${schema}SUPPLIER${org} ( S_SUPPKEY     INTEGER NOT NULL WITH STORAGETYPE = COLUMNAR,
...
CREATE TABLE ${schema}PARTSUPP${org} ( PS_PARTKEY     INTEGER NOT NULL WITH STORAGETYPE = COLUMNAR,
...
CREATE TABLE ${schema}CUSTOMER${org} ( C_CUSTKEY     INTEGER NOT NULL WITH STORAGETYPE = COLUMNAR,
...
CREATE TABLE ${schema}ORDERS${org}  ( O_ORDERKEY       INTEGER NOT NULL WITH STORAGETYPE = COLUMNAR,
...
CREATE TABLE ${schema}LINEITEM${org} ( L_ORDERKEY    INTEGER NOT NULL WITH STORAGETYPE = COLUMNAR,
